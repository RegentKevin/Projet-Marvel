...
<html>
  <head>
    <?php require_once __DIR__ . '/../include/head.php' // permet de récupérer le chemin du dossier include pour inclure le head ?>
  </head>
  <body>
    ...
    <?php require_once __DIR__ . '/../include/footer.php' // permet de récupérer le chemin du dossier include pour inclure le head ?>
  </body>
</html>
